...
package net.asianovel.reader.ui.main
...
import net.asianovel.reader.databinding.ActivityMainBinding
...
import net.asianovel.reader.lib.permission.Permissions
import net.asianovel.reader.lib.permission.PermissionsCompat
import net.asianovel.reader.lib.theme.elevation
...
import net.asianovel.reader.ui.main.bookshelf.style1.BookshelfFragment1
import net.asianovel.reader.ui.main.bookshelf.style2.BookshelfFragment2
import net.asianovel.reader.ui.main.explore.ExploreFragment
import net.asianovel.reader.ui.main.my.MyFragment
import net.asianovel.reader.ui.main.rss.RssFragment
...
class MainActivity : VMBaseActivity<ActivityMainBinding, MainViewModel>(),
    ...
    private suspend fun privacyPolicy(): Boolean = suspendCoroutine { block ->
        ...
        alert("privacy policy", privacyPolicy) {
            noButton {
                finish()
                block.resume(false)
            }
