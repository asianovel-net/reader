...
import net.asianovel.reader.help.storage.BackupConfig
import net.asianovel.reader.help.storage.ImportOldData
import net.asianovel.reader.help.storage.Restore
...
class BackupConfigFragment : PreferenceFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<net.asianovel.reader.lib.prefs.Preference>("web_dav_restore")
