...
package net.asianovel.reader.ui.widget.code
...
val readerPattern: Pattern = Pattern.compile("\\|\\||&&|%%|@js:|@Json:|@css:|@@|@XPath:")
...
fun CodeView.addreaderPattern() {
    addSyntaxPattern(readerPattern, appCtx.color(R.color.md_orange_900))
}
