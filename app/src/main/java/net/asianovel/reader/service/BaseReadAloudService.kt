...
import net.asianovel.reader.help.MediaHelp
...
import net.asianovel.reader.receiver.MediaButtonReceiver
...
abstract class BaseReadAloudService : BaseService(),
    ...
    private val wakeLock by lazy {
        powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "reader:ReadAloudService")
            .apply {
