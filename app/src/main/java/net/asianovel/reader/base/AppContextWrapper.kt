package net.asianovel.reader.base
...
import net.asianovel.reader.utils.getPrefInt
import net.asianovel.reader.utils.getPrefString
import net.asianovel.reader.utils.sysConfiguration
import java.util.*
...
object AppContextWrapper {
     ...
     * 当前设置语言
     */
    public fun getSetLocale(context: Context): Locale {
