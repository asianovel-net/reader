package net.asianovel.reader.help.storage
...
import net.asianovel.reader.constant.AppConst.androidId
...
import net.asianovel.reader.help.LauncherIconHelp
import net.asianovel.reader.help.book.isLocal
import net.asianovel.reader.help.book.upType
