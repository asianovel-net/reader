package net.asianovel.reader.help.http
...
object Cronet {
    ...
    val loader: LoaderInterface? by lazy {
        kotlin.runCatching {
            Class.forName("net.asianovel.reader.lib.cronet.CronetLoader")
    ...
    val interceptor: Interceptor? by lazy {
        kotlin.runCatching {
            val iClass = Class.forName("net.asianovel.reader.lib.cronet.CronetInterceptor")
