...
> result 变量-上一步的结果  
> book 变量-[书籍类](https://github.com/asianovel-net/reader/blob/master/app/src/main/java/net/asianovel/reader/data/entities/Book.kt)  
> chapter 变量-[当前目录类](https://github.com/asianovel-net/reader/blob/master/app/src/main/java/net/asianovel/reader/data/entities/BookChapter.kt)  
> source 变量-[基础书源类](https://github.com/asianovel-net/reader/blob/master/app/src/main/java/net/asianovel/reader/data/entities/BaseSource.kt)  
> cookie 变量-[cookie操作类](https://github.com/asianovel-net/reader/blob/master/app/src/main/java/net/asianovel/reader/help/http/CookieStore.kt)  
> cache 变量-[缓存操作类](https://github.com/asianovel-net/reader/blob/master/app/src/main/java/net/asianovel/reader/help/CacheManager.kt)  
...
### [AnalyzeUrl](https://github.com/asianovel-net/reader/blob/master/app/src/main/java/net/asianovel/reader/model/analyzeRule/AnalyzeUrl.kt) 部分函数
...
### [AnalyzeRule](https://github.com/asianovel-net/reader/blob/master/app/src/main/java/net/asianovel/reader/model/analyzeRule/AnalyzeRule.kt) 部分函数
* 获取文本/文本列表
...
### [js扩展类](https://github.com/asianovel-net/reader/blob/master/app/src/main/java/net/asianovel/reader/help/JsExtensions.kt) 部分函数
