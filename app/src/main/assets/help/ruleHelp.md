...
> 部分变量说明：java（仅支持[js扩展类](https://github.com/asianovel-net/reader/blob/master/app/src/main/java/net/asianovel/reader/help/JsExtensions.kt)），result为待解密图片的`ByteArray`，src为图片链接
