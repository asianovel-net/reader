...
## 对外提供api
-keep class net.asianovel.reader.api.ReturnData{*;}
...
# Class.forName调用
-keep class net.asianovel.reader.lib.cronet.CronetInterceptor{*;}
-keep class net.asianovel.reader.lib.cronet.CronetLoader{*;}
-keep class net.asianovel.reader.help.AppUpdateGitHub{*;}
